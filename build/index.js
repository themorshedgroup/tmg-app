...
function CallsTab({
  ...
  async function load(force) {
    ...
    if (callsIsDev()) {
      ...
      setBuckets({
        yesterday: spread(dates.yesterday, 11, 0),
...
function AddKpiSheet({
  ...
  const options = KPI_OPTIONS.map(k => ({
    key: k,
    label: k,
    requireCount: /hotzone/i.test(k)
  }));
  ...
  const items = callPicks.map(o => ({
    ...
    kind: o.key,
    subject: o.key === 'Touch Call' ? (tier ? tier + ' ' : '') + 'Touch Call: ' + (contact ? contact.name : '') : 'Follow Up Call : ' + (contact ? contact.name : '')
  }));
    ...
    try {
      ...
      if (items.length) {
        ...
        items.forEach(it => {
          ...
          if (t && !adopted.some(a => a.id === t.id)) {
            adopted.push(t);
            count -= 1;
          }
          if (count > 0) surplus.push({
            type: it.type,
            count,
            subject: it.subject
          });
        ...
        if (surplus.length) await createActivityTasks({
          items: surplus,
      ...
      if (otherPicks.length) {
        ...
        otherPicks.forEach(o => done.push({
          count: Number(sel[o.key]),
          subject: o.key
        }));
      }
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, searching ? '…' : 'Find')), hits && hits.length === 0 && !creating && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '8px 2px'
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "No contact matched \u201C", q.trim(), "\u201D."), /*#__PURE__*/React.createElement("button", {
    onClick: startCreate,
    style: {
      display: 'inline-flex',
      alignItems: 'center',
  ...
  }), " Create \u201C", q.trim(), "\u201D")), creating && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gap: 6,
      marginTop: 4
    ...
    style: {
      ...
      color: creating.classification === o ? addCol : headTitle
    }
  }, o))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
  ...
  }, saving ? 'Saving…' : 'Create contact')), err && /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: J,
      fontSize: 9,
      color: redCol,
  ...
  }, err)), hits && hits.map(c => /*#__PURE__*/React.createElement("button", {
    key: c.id,
    onClick: () => pick(c),
    style: {
      display: 'block',
  ...
  }, "You\u2019re logging a touch call ", gapDays, " days after the last one, against a ", interval, "-day cadence. This is the case that gets sent for validation."), (items.length > 0 || otherPicks.length > 0) && /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: J,
      fontSize: 8,
      color: mutedCol,
    ...
    key: 'c' + i
  }, it.count, " \xD7 ", it.subject)), otherPicks.map(o => /*#__PURE__*/React.createElement("div", {
    key: 'o' + o.key
  }, Number(sel[o.key]), " \xD7 ", o.key, " \u2014 ", contact.name))), err && /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: J,
      fontSize: 9,
      color: redCol,
